                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> <button type="button" class="btn btn-primary" onclick="AddServico(<?php echo $serv_row->idServico ?> , '<?php echo $serv_row->nomeServico ?>', <?php echo $serv_row->precoServico ?>)"> <i class="bi bi-plus-lg"></i></button></td>
                                    </tr>
                                <?php
                                }
                                ?>
